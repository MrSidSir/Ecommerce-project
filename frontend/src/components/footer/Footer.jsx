              ...
              <div className="relative">
                <div className="flex">
                  <input
                    ...
                    className="flex-1 bg-transparent border border-gray-600 rounded-l px-3 py-2 text-sm focus:outline-none focus:border-white"
                  />
                  <button
                    onClick={handleSubscribe}
                    className="bg-white text-black px-4 py-2 rounded-r hover:bg-gray-200 transition-colors"
                  >
                    <Mail size={16} />
                  </button>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="flex items-center space-x-2 bg-gray-800 rounded px-3 py-2 hover:bg-gray-700 transition-colors w-full"
                >
              ...
              <div className="flex space-x-4 pt-4">
                <button
                  onClick={() => handleExternalLink('https://www.facebook.com/sayyad.irshad.92')}
                  className="text-gray-300 hover:text-white transition-colors"
                >
                  <Facebook size={20} />
                </button>
                <button
                  onClick={() => handleExternalLink('https://x.com/Mrsidsir4404')}
                  className="text-gray-300 hover:text-white transition-colors"
                >
                  <Twitter size={20} />
                </button>
                <button
                  onClick={() => handleExternalLink('https://www.instagram.com/mr_sid_sir?igsh=MXE4aG5wMXJoZTUxeQ==')}
                  className="text-gray-300 hover:text-white transition-colors"
                >
                  <Instagram size={20} />
                </button>
                <button
                  onClick={() => handleExternalLink('https://www.linkedin.com/in/syed-irshad-132638287/?trk=public-profile-join-page')}
                  className="text-gray-300 hover:text-white transition-colors"
                >
                  <Linkedin size={20} />
                </button>
